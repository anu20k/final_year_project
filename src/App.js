...
import HospitalProfile from "./components/hospital/Profile.js";
import HospitalDoctorInfo from "./components/hospital/DoctorInfo.js";
    ...
    <div>
      <Router>
        <Routes>
          ...
          <Route
            path="/hospital/doctorInfo"
            element={<HospitalDoctorInfo />}
          ></Route>
          <Route
            path="/hospital/auth/registration"
            element={<HospitalRegistration />}
          ></Route>
          <Route
            path="/hospital/auth/forgotpass"
            element={<HospitalForgotpass />}
          ></Route>
          <Route
            path="/hospital/fetchPatientEmergencyRecord"
            element={<FetchPatientEmergencyRecord />}
          ></Route>
          <Route
            path="/hospital/fetchPatientEmergencyRecord/face"
            element={<FetchByFace />}
          ></Route>
          <Route
            path="/hospital/fetchPatientEmergencyRecord/fingerprint"
            element={<FetchByFingerprint />}
          ></Route>
          <Route
            path="/hospital/fetchPatientEmergencyRecord/aadharId"
            element={<FetchByAadharId />}
          ></Route>
          <Route
            path="/hospital/auth/login"
            element={<HospitalLogin />}
          ></Route>
          <Route path="/hospital/patientinfo" element={<Patientinfo />}></Route>
          <Route path="/hospital/auth/otp" element={<Otp />}></Route>
          <Route
            path="/hospital/auth/otpverification"
            element={<OtpVerification />}
          ></Route>

          <Route
            path="/hospital/patientAllRecords"
            element={<PatientAllRecords />}
          />

          <Route
            path="/UHR/addpatientrecords"
          ...
          <Route
            path="/doctor/auth/registration"
            element={<DoctorRegistration />}
          ></Route>
          <Route
            path="/doctor/auth/forgotpass"
            element={<DoctorForgotpass />}
          ></Route>
        </Routes>
      </Router>
    </div>
